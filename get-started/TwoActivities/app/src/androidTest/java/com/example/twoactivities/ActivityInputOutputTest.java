...
public class ActivityInputOutputTest {
    ...
    // test whether the SecondActivity View elements appear when clicking the Button and vice versa
    @Test
    ...
    // test for text input MainActivity and output SecondActivity
    @Test
